...
class UploadAndUpdateProfilePicView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        return api_response(
            False, "Invalid Profile Pic data", data=serializer.errors, status_code=400
        )
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                return api_response(
                    False, "Failed to update cover photo", data=str(e), status_code=500
                )
        return api_response(
            False, "Invalid photo data", data=serializer.errors, status_code=400
        )
...
class UpdatePhoneNumberView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        return api_response(
            False, "Invalid phone number data", data=serializer.errors, status_code=400
        )
