...
class Command(BaseCommand):
    ...
    def start_notification_consumer(self):
        ...
        consumer.subscribe(['attended_task'])  # Subscribe to the Kafka topic
            ...
            while True:
                ...
                if msg is None:
                    ...
                    if msg.error():
                        ...
                        if tutor_code:
                            print(f"Processing session with code: {tutor_code}")
...
# docker exec -it kafka kafka-topics.sh --create --topic attended_task --bootstrap-server kafka:9092 --partitions 1 --replication-factor 1
